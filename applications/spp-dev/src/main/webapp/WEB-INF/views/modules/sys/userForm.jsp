...
<div class="modal-header modalsbg">
	...
	<h5 class="modal-title"><spring:message code="sys.user.add"/></h5>
</div>
		...
		<div class="box-body">
			<div class="col-md-6">
				<div class="form-group">
					<label for="office.id" class="col-sm-3 control-label"><spring:message code="sys.user.office"/></label>
					<div class="col-sm-8">
			...
			<div class="form-group">
					...
					<label class="control-label">
						<form:checkboxes path="roleIdList" items="${allRoles}" cssClass="styled"
							element="div class='checkbox-inline checkbox checkbox-success'"  itemLabel="name"  itemValue="id" htmlEscape="false"/>
					</label>
					</div>
				</div>
			</div>
							...
							fields : {
							 ...
							 modals.confirm({
									...
									callback: function() {
										...
										var params = userform.getFormSimpleData();
										ajaxPost(basePath + '/sys/user/save',
