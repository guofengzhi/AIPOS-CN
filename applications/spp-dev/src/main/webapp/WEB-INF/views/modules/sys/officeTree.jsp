...
<%@ include file="/WEB-INF/views/common/commonsjs.jsp"%><div class="col-md-12"></div>
</section>
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<form class="form-horizontal" id="office-form">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"><spring:message code="common.OrganizationOrDepartment" /><span style="color:red">*</span></label>
							<div class="col-sm-9">
								<label class="control-label"> <input type="radio"
									name="type" class="flat-red" checked="checked" value="1">
									<spring:message code="sys.user.office" />
								</label> &nbsp;&nbsp;&nbsp; <label class="control-label"> <input
									type="radio" name="type" class="flat-red" value="2">
									<spring:message code="sys.user.department" />
								</label>
							</div>
						</div>
						<div class="form-group">
							<label for="grade" class="col-sm-2 control-label"><spring:message code="common.form.select" /><span style="color:red">*</span></label>
							<div class="col-sm-9">
									<label class="control-label"> 
										<input type="radio"  name="grade" class="flat-red" checked="checked" value="1"><spring:message code="sys.organ.oneLevel" />
									</label>
									<label class="control-label"> 
										<input type="radio"  name="grade" class="flat-red"  value="2"><spring:message code="sys.organ.twoLevel" />
									</label>
									<label class="control-label"> 
										<input type="radio"  name="grade" class="flat-red"  value="3"><spring:message code="sys.organ.threeLevel" />
									</label>
									<label class="control-label"> 
										<input type="radio"  name="grade" class="flat-red"  value="4"><spring:message code="sys.organ.fourLevel" />
								    </label>
							</div>
						</div>
						<div class="form-group">
			...
			$(function() {
				...
				$("#office-form").bootstrapValidator({
					...
					fields : {
						...
						grade :{
							validators:{
								notEmpty:{
									message:'<spring:message code="common.form.select" />'
								}
							}
						},
						deleted : {
				...
				$('button[data-btn-type]').click(function() {
					...
					case 'deleteOffice':
					    ...
					    $.ajax({
							type: "POST",
							url: basePath+"/sys/office/selectOfficeUser?id="+selectedNode.id,
							dataType:'json',
							cache: false,
					    ...
					    modals.confirm({
                            ...
                            text:"<spring:message code="sys.organ.confirm.deleteNode" />",
                            callback:function(){
