...
(function ($, window, document, undefined) {
    ...
    BaseOrg.prototype.loadContent = function () {
     ...
     /*   $("#" + this.orgId).find("div.modal-footer").append('<button class="btn btn-primary" type="button" data-btn-type="selectOrg">确定</button>')*/
        $("#" + this.orgId).find("div.modal-footer").append("<button class=\"btn btn-primary\" type=\"button\" data-btn-type=\"cancelOrg\">"+cancel+"</button>");
        $("#" + this.orgId).find("div.modal-footer").append("<button class=\"btn btn-primary\" type=\"button\" data-btn-type=\"clearOrg\">"+remove+"</button>");
        this.initOrgTree();
        var self = this;
       ...
       //点击事件
       $("#" + this.treeId).on('click','li',function(){
       	  self.selectOrg();
   	   });
    }
