...
import com.jiewen.jwp.common.annotation.ExcelField;
import com.jiewen.modules.sys.fieldtype.RoleListType;
...
public class User extends DataEntity implements Serializable {
    ...
    private String isDeveloper; //是否是开发者 0：否，1：是
	...
	private transient SysUserRole sysUserRole;
	
	private transient List<SysUserRole> sysUserRoleList = Lists.newArrayList(); 
	...
	private transient Role role; // 根据角色查询用户条件

    private transient List<Role> roleList = Lists.newArrayList(); // 拥有角色列表
    ...
    @JsonIgnore
    @Length(min = 1, max = 272, message = "密码长度必须介于 1 和 272 之间")
    ...
    @ExcelField(title = "所属代理商", align = 2, sort = 25)
