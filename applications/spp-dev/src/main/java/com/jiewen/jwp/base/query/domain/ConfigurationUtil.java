...
public final class ConfigurationUtil {
    ...
    public static Object parseXMLObject(final Class clazz, Resource resource) throws RuntimeException {
        ...
        try {
            ...
            log.error(String.format("Fail to transfer Java Object[class: {" 
                       +clazz.getSimpleName()+"}] from {"+resource+"}, reason: "), e);
            throw new RuntimeException((
            		new StringBuilder()).append("Fail to parse XML Object of ").append(resource).toString(), e);
        }
    }

    public static Resource[] getSortedResources(String location1) {

        Resource resources[];
        
        String location =prepareLocation(location1);
    ...
    public static Resource[] getAllResources(String location1) {
    ...
    private static String prepareLocation(String location1) {
    ...
    public static void setDominator(String d) {
        ...
        if (dominator == null) {
            ...
            log.warn("The dominator has already bean set as {"
            +dominator+"}, and now try to set as {"+d+"} which will be ignored.");
        }
    }
