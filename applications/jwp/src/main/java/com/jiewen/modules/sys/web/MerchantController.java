...
public class MerchantController extends BaseController {
	...
	public String index(Merchant merchant, Model model) {
		...
		model.addAttribute("baiduGoogle", baiduGoogle);
	...
	public @ResponseBody Map<String, Object> boundTermList(String reqObj, HttpServletRequest reqeust) throws Exception {
	   ...
	   /**
		...
		@RequestMapping(value = "MerchantEditOrAdd")
		@ResponseBody
		public Merchant form(String id, Model model) {
	    	Merchant merchant = new Merchant();
	...
	public Map<String, Boolean> checkMerId(String merId,String merIdOld) {
		Merchant merchant = systemService.getMerchantByMerId(merId);
		Map<String, Boolean> map = new HashMap<String, Boolean>();
		boolean valid = false;
		if(merId !=null && !"".equals(merId) && merIdOld !=null && !"".equals(merIdOld)){//修改
			if(merId.equals(merIdOld)){
				valid = true;
			}else{
				if (merchant == null) {
					valid = true;
    ...
    @ResponseBody
    public Result save(Merchant merchant) {
