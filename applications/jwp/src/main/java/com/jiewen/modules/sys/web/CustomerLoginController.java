...
public class CustomerLoginController extends BaseController {
    ...
    public String login(HttpServletRequest request, HttpServletResponse response) {
        ...
        return "modules/customer/sysLogin";
    }
    ...
    public String logout() {
        ...
        return "redirect:" + adminPath + "/customer/login";
    }

    @RequestMapping(value = "${adminPath}/customer/homePage")
    public String home() {
        return "modules/customer/homePage";
    }
    ...
    public String index(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (principal.isMobileLogin()) {
            ...
            if (request.getParameter("index") != null) {
                return "modules/customer/sysIndex";
            }
            return "redirect:" + adminPath + "/customer/login";
        }
    ...
    @RequiresPermissions("user")
    @RequestMapping(value = "/customer/getMenuList")
    @ResponseBody
