...
public class Query {
    ...
    private List<Column> staticColumnList;

    private Map<String, Column> columnMap;

    private Map<String, Column> staticColumnMap;
    ...
    public Query() {
        ...
        staticColumnList = new ArrayList<>();
        columnMap = new HashMap<>();
        staticColumnMap = new HashMap<>();
        widthType = "px";
        allowPaging = true;
    ...
    public void addColumn(Column queryColumn) {
        ...
        staticColumnList.add(queryColumn);
        columnMap.put(queryColumn.getId() != null ? queryColumn.getId() : queryColumn.getKey(), queryColumn);
        staticColumnMap.put(queryColumn.getId() != null ? queryColumn.getId() : queryColumn.getKey(), queryColumn);
    }
    ...
    public List<Column> getStaticColumnList() {
        return staticColumnList;
    }

    public void setStaticColumnList(List<Column> staticColumnList) {
        this.staticColumnList = staticColumnList;
    }

    public Map<String, Column> getStaticColumnMap() {
        return staticColumnMap;
    }

    public void setStaticColumnMap(Map<String, Column> staticColumnMap) {
        this.staticColumnMap = staticColumnMap;
    }
