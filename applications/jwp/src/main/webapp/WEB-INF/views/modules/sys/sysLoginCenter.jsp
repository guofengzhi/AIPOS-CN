...
<link rel="stylesheet"
	href="${ctxStatic}/common/css/login.css">
<link rel="stylesheet"
...
<body>
	 ...
	 <div class="header">
	  ...
	  <img src="${ctxStatic}/common/images/logo.png" id="loginID"  style="margin-top:1%;" >
			...
			<form class="form form-horizontal" action="${basePath}/login" method="post" id="login-form">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8">
                        ...
                        <input type="checkbox" name="rememberMe" id="rememberMe"> <font style="color:black"><spring:message code="sys.login.select.logined" /></font></label>
                       <%--    <label for="rememberLogin">
                        <input type="checkbox" name="rememberLogin" id="rememberLogin"> <font style="color:black"><spring:message code="sys.login.select.logine" /></font></label> --%>
                    </div>
                </div>
                <div class="row cl">
                    <div class="formControls col-xs-8 col-xs-offset-3">
	...
	<script>
		...
		$(function() {
			...
			/*  $(".loginWraper").css("background","#3283AC url(${basePath}/common/images/"+loginIMG+".jpg) no-repeat center"); */
			$('input').iCheck({
