...
<div class="modal-body">
	<div class="box-body">
		<button class="btn btn-info btn lg text-center" id="downLoadMerTemp">
			<spring:message
				code="modules.device.download.the.device.information.template" />
		</button>
...
$("#downLoadMerTemp").click(function() {
	$.download(basePath + "/sys/merchant/downloadUnBoundTermTemplate", "post", "");
});
	$(function() {
		...
		uploader = WebUploader
				.create({
					...
					// 文件接收服务端。
					server : basePath + "/sys/merchant/merchantBatchUnBound",
						...
						function() {
							...
							case 'downloadTemplate':
								window.location.href = basePath
										+ "/sys/merchant/downloadUnBoundTermTemplate"; */
						/* 		break;
							case 'uploadBoundList':
								$
										.ajax({
											url : basePath
													+ "/sys/merchant/batchBoundTerm",
											success : function() {
												modals
														.correct({
