...
<!-- Logo -->
<a href="${basePath}/customer" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				   ...
				   <!-- User image -->
					...
					<li class="user-footer">
						...
						<div class="pull-right">
							<a href="${basePath}/customer/logout" class="btn btn-default btn-flat"><spring:message code="sys.login.exit"/></a>
						</div>
					</li>
				</ul>
			</li>
