...
设置一下网站支持的语言种类
 */
var webLanguage = ['zh-CN', 'zh-TW', 'en-US'];

/**
 * 执行页面i18n方法
 * @return 切换语言 需要清除浏览器cookies
 */
var execI18n = function() {
    ...
    jQuery.i18n.properties({
    	...
    	//,callback: function(){
    	//	console.log(jQuery.i18n.prop('common.sys.confirmbutton'))
    	//}
    });
}
