...
(function() {
	 ...
	 */
    var _CONFIG = {
        ok_label: $.i18n.prop("common.sys.confirmbutton"),
        cancel_label: $.i18n.prop("common.close"),
        large: false
    };
    ...
    var _TITLE = { info: $.i18n.prop('common.sys.info'), success: $.i18n.prop('common.sys.success'), warning: $.i18n.prop('common.sys.warn'), error: $.i18n.prop('common.sys.error') };
    function _alert(args, type) {
        var cfg = modal_params.apply(this, args);
        cfg.title = cfg.title||_TITLE[type];
        cfg.type=type;
        if(type=="info"){
        	return _create_layer(cfg);
        }if(type=="error"){
        	return _create_swal(cfg);
        }else{
        	_create_modal(cfg, false, true);
        }
    }
    
    function _create_swal(cfg){  
    	_remove_modal();
    	swal({ title: cfg.title,
    		   type: cfg.type,
    		   html: cfg.text,
    		   confirmButtonText:cfg.ok_label
    ...
    function _create_layer(cfg){
    	_remove_modal();
    	layer.msg(cfg.text,{anim:6,icon:0});
    }
    ...
    modals.correct = function() {
        return _alert.call(this, arguments, 'success');
    };

    modals.warn = function() {
        return _alert.call(this, arguments, 'warning');
    };
    ...
    modals.confirm = function() {
        ...
        cfg.title = cfg.title||$.i18n.prop("common.sys.confirmTip");
        cfg.cancel_label = cfg.cancel_label==_CONFIG.cancel_label?$.i18n.prop("common.cancel"):cfg.cancel_label;
