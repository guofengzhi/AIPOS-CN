...
package com.jiewen.base.common.web;
...
public class ServletsUtils {
	...
	// -- 常用数值定义 --//
	public static final long ONE_YEAR_SECONDS = (long) 60 * 60 * 24 * 365;
		...
		if (staticFiles == null) {
			try {
				throw new Exception("检测到“app.properties”中没有配置“web.staticFile”属性。配置示例：\n#静态文件后缀\n"
						+ "web.staticFile=.css,.js,.png,.jpg,.gif,.jpeg,.bmp,.ico,.swf,"
						+ ".psd,.htc,.crx,.xpi,.exe,.ipa,.apk");
			} catch (Exception e) {
			}
		}
	...
	public void ingoreUtilityCheck() {
