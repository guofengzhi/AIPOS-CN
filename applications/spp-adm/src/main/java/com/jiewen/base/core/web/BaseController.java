...
public abstract class BaseController {
    ...
    @Value("${ftp.base.download.url}")
	protected String ftpBaseLoadUrl;
     ...
     * @return
     */
    public Map<String, Object> resultMap(BaseEntity<?> entity,
            @SuppressWarnings("rawtypes") PageInfo pageInfo) {
        Map<String, Object> model = new HashMap<>();
        if (pageInfo.getTotal() == -1) {
            pageInfo.setTotal(entity.getTotals());
        }
        model.put("pageInfo", pageInfo);
        model.put("query", entity.getQuery());
        return model;
