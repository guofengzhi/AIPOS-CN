...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li class="active"><spring:message code="sys.advertisement.approve"/></li>
    </ol>
            ...
            <div class="box">
                <div id="advertisementSearchDiv" class="dataTables_filter" role="form" style="text-align: left;">
                   <div class="has-feedback form-group">
                            <input class="form-control" id="adName" type="text"  style="margin-left:0px;width: 226.5px;"
                                name="adName" placeholder='<spring:message code="sys.advertisement.adName"/>' />
                   </div> 
                    <div class="has-feedback form-group">
                            <input class="form-control" id="adTitle" type="text" style="margin-left:0px;width: 226.5px;"
