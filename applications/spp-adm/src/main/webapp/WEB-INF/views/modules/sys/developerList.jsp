...
<section class="content-header">
	<ol class="breadcrumb">
		...
		<li><a href="#"><spring:message code="sys.developer.management" /></a></li>
		<li class="active"><spring:message code="sys.developer.management" /></li>
	</ol>
			...
			<div class="box">
				...
				<div id="userSearchDiv" class="dataTables_filter" style="text-align: left;" role="form">
					<div class="has-feedback form-group">
						<input id="userOrgSelect" style="width: 226.5px;" name="officeId" class="form-control"  type="hidden"/>
						<input id="userOrgSelectValue" readonly="readonly" style="width: 226.5px;margin-left:0px;" name="orgIdValue" class="form-control" type="text" placeholder='<spring:message code="please.select.organ" />'/>
					</div>
					<div class="has-feedback form-group">
					...
					<div style="width:100%;margin-top:5px;">
						<shiro:hasPermission name="sys:developer:edit">
...
<script>
	...
	$(function() {
		...
		userTable = new CommonTable("developer_table", "userTable", "userSearchDiv",
				"/sys/developer/list",config);
				...
				.click(
						function() {
							...
							case 'userAdd':
								modals.openWin({
									winId : winId,
									title : '<spring:message code="sys.developer.add"/>',
									width : '900px',
									url : basePath + "/sys/developer/form"
								});
								break;
							case 'userEdit':
								if (!userRowId) {
								...
								modals
										.openWin({
											winId : winId,
											title : '<spring:message code="sys.developer.edit"/>【'
													+ userTable
															.getSelectedRowData().name
													+ '】',
											width : '900px',
											url : basePath
													+ "/sys/developer/form?id="
													+ userRowId
										});
								break;
							case 'userDelete':
								...
								modals.confirm({
									...
									callback: function() {
									ajaxPost(basePath + "/sys/developer/delete?id="
							...
							case 'userExport':
								modals.confirm('<spring:message code="sys.user.confirm.export"/>', function() {
									$.download(basePath + "/sys/developerManagement/export",
											"post", "userSearchDiv");
								})
							}
