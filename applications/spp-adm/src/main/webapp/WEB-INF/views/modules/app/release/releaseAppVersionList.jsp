...
<section class="content-header">
	<ol class="breadcrumb">
		...
		<li><a href="#"><spring:message code="app.release.application.version.management"/></a></li>
		<li class="active"><spring:message code="app.release.version.information.list"/></li>
	</ol>
