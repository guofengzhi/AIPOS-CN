...
<section class="content-header">
	<ol class="breadcrumb">
		...
		<li><a href="#"><spring:message code="app.developer.application.developer.information.management"/></a></li>
		<li class="active"><spring:message code="app.developer.application.developer.information.list"/></li>
	</ol>
