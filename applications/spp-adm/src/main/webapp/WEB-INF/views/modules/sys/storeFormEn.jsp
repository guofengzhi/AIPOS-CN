...
<body>
	...
	<div class="modal-body">
		<form:form id="store-form" name="store-form" modelAttribute="store"
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<label for="storeName" class="col-sm-3 control-label"><spring:message
								code="sys.store.name" /><span style="color: red">*</span></label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="storeId" class="col-sm-3 control-label"><spring:message
								code="sys.store.id" /><span style="color: red">*</span></label>
						<div class="col-sm-8">
							<form:input type="text" htmlEscape="false" class="form-control"
					...
					<div class="form-group">
						<label for="linkMan" class="col-sm-3 control-label"><spring:message
								code="sys.store.linkMan" /><span style="color: red">*</span></label>
						<div class="col-sm-8">
							<form:input type="text" htmlEscape="false" class="form-control"
					...
					<div class="form-group">
						<label for="linkPhone" class="col-sm-3 control-label"><spring:message
								code="sys.store.mobile" /><span style="color: red">*</span></label>
						<div class="col-sm-8">
							<form:input type="text" htmlEscape="false" class="form-control"
					...
					<div class="form-group">
						<label for="address" class="col-sm-3 control-label"><spring:message
								code="sys.store.address" /><span style="color: red">*</span></label>
						<div class="col-sm-8">
							<form:input type="text" htmlEscape="false" class="form-control"
