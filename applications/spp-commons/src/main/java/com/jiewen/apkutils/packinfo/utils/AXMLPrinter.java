...
package com.jiewen.apkutils.packinfo.utils;
...
public class AXMLPrinter {
    ...
    public static final Logger logger = LoggerFactory.getLogger(AXMLPrinter.class);
    ...
    public static String getManifestXMLFromAPK(String apkPath) {
        ...
        try (ZipFile file = new ZipFile(apkFile, ZipFile.OPEN_READ)) {
            ...
            while ((type = parser.next()) != XmlPullParser.END_DOCUMENT) {
                ...
                case XmlPullParser.START_TAG: {
                    log(false, xmlSb, "%s<%s%s", sb, getNamespacePrefix(parser.getPrefix()),
                            parser.getName());
                ...
                case XmlPullParser.END_TAG: {
                    ...
                    log(xmlSb, "%s</%s%s>", sb, getNamespacePrefix(parser.getPrefix()),
                            parser.getName());
                    break;
                }
            ...
            logger.error("parser error apk xml {}", e.getMessage());
        }
        return xmlSb.toString();
    }

    public static String getManifestXMLFromAPK(File apkFile) {
        StringBuilder xmlSb = new StringBuilder(100);
        try (ZipFile file = new ZipFile(apkFile, ZipFile.OPEN_READ)) {
    ...
    private static void log(boolean newLine, StringBuilder xmlSb, String format,
            Object... arguments) {
